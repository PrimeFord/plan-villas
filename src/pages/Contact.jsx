  ...
  return (
    <div className="grid grid-cols-2 divide-x-[1px] divide-[#7A7A7A]">
      <div className="px-[3rem] py-[4rem] flex flex-col gap-8">
        <h2 className="text-[3rem] font-[600] ">CONTACT US</h2>
        <p className="leading-[1.8rem] w-[75%] ">
          Got a question about one of our listings, want to sell your property
          or just want to make enquires? Contact us and we&apos;ll get back to
          you ASAP!
        </p>
